...
function fnStart()
{
    ...
    $("#resultsButtons").hide()
    $("#resultsButtonTheses").html("Begründungen - Fragen und Antworten anzeigen")
    $("#resultsButtonParties").html("Standpunkte - Kandidierende und Antworten anzeigen")
...
//		for (i = 0; i < arPartyFiles.length; i++)
        ...
        $('#resultsByThesis').toggle(fadeTimeMs);
...
function fnEvaluationShort(arResults)
{
    ...
    $("#resultsHeading").append("<h1>Ergebnisse</h1>").fadeIn(500);
...
function fnEvaluationByThesis(arResults)
{
    ...
    tableContent += " <p>"+"Sie können Ihre eigene Meinung in der zweiten Spalte noch einmal anpassen und das neue Ergebnis überprüfen. <br /> Die <strong>Antworten der Kandidierenden</strong> erhalten Sie <strong>beim Klick auf das Plus-Zeichen</strong>."+"</p>";
    /*
    tableContent += "<table width='100%' id='resultsByThesisTable' class='table table-bordered table-striped table-hover'>";
    tableContent += "<caption>"+"Sie können Ihre eigene Meinung in der zweiten Spalte noch einmal anpassen und das neue Ergebnis überprüfen. <br /> Die <strong>Antworten der Kandidierenden</strong> erhalten Sie <strong>beim Klick auf das Plus-Zeichen</strong>."+"</caption>";
            ...
            tableContent += "<thead>";
                tableContent += "<tr>";
                    ...
                    tableContent += "Ihre Antwort"+" &amp; "+"Position des/der Kandidat\*in"
                    tableContent += "</th>";

                    tableContent += "<th class='align-text-top'>";	
                    tableContent += "Frage"+" &amp; "+"Antwort des/der Kandidat\*in"
                    tableContent += "</th>";
                ...
                tableContent += "<div class='row border' role='row'>";
                    ...
                    tableContent += "<div class='col col-2' role='cell'>";
                        ...
                        // tableContent += "<button type='button' "+
                            ...
                            " alt='Ihre Antwort: "+positionText+"' title='Ihre Antwort: "+positionText+"'>"+
                            " "+positionIcon+"</button>";
                        ...
                        if (arVotingDouble[i])
                        {
                            tableContent += "<button type='button' class='btn btn-dark btn-sm' "+
                                " id='doubleIcon"+i+"' "+
                                " onclick='fnToggleDouble("+i+")' title='Frage doppelt gewertet'>x2</button>";						
                        }
                        else			
                        {
                        tableContent += "<button type='button' class='btn btn-outline-dark btn-sm' "+
                                " id='doubleIcon"+i+"' "+
                                " onclick='fnToggleDouble("+i+")' title='Frage einfach gewertet'>x2</button>";
...
//								tableContent += " <div class='col-1'> </div> ";
                                ...
                                //tableContent += "<p>"
                                    tableContent += "<button type='button' class='btn "+positionButton+" btn-sm' disabled "+
                                            " alt='Antwort des/der Kandidat\*in: "+positionText+"' title='Antwort des/der Kandidat\*in: "+positionText+"'>"+
                                            " "+positionIcon+"</button>";
                                tableContent += "</div>";							
...
function fnEvaluationByParty(arResults)
{
    ...
    tableContent += " <p>Dies ist eine Übersicht aller Kandidat\*innen und ihrer Antworten.</p>";
